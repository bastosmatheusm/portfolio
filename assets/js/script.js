...
async function getAboutGitHub() {
	try {
		...
		const resposta = await fetch(
			'https://api.github.com/users/bastosmatheusm',
		)
      ...
      <article class="about-content">
        ...
        <div class="about-buttons-data">
          ...
          <div class="buttons-container">
            ...
            <a href="https://drive.google.com/file/d/16etYPk3OoIHHCs573_OeueAUA4TnUzzG/view?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
          </div>
...
async function getProjectsGitHub() {
	try {
		// Requisição do tipo GET para a API do GitHub
		const resposta = await fetch(
			'https://api.github.com/users/bastosmatheusm/repos?sort=updated&per_page=6',
		)
